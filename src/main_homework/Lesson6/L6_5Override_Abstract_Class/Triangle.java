...
public class Triangle extends Figure{
    ...
    public Triangle(int width, int height){
        super(width, height);  //конструктор наследника должен вызвать явно конструктор супер класса, если в супер классе конструктор имеет параметры, инициализировать не нужно this.width=width;
            }
    @Override
